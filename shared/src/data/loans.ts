import { Loan, LenderType, LoanCategory, OrganizationType } from '../types/loan.types';

/**
 * Shared loan data for the Loan Management System
 * This data is used across both frontend and backend
 * Source: Curated from government websites, bank portals, and financial institutions
 */
...
export const LOAN_DATA: Loan[] = [
  // Government Schemes - India
  {
    ...
    lenderType: LenderType.GOVERNMENT,
    category: LoanCategory.STARTUP,
    country: "India",
    interestRate: "0%",
    loanAmount: {
      min: 500000,
  ...
  },
  {
    ...
    eligibility: {
      ...
      minIncome: 100000,
      creditScoreMin: 0,
      organizationType: [OrganizationType.SME, OrganizationType.INDIVIDUAL],
      businessAge: 0,
  ...
  },
  {
    ...
    eligibility: {
      ...
      minIncome: 200000,
      creditScoreMin: 650,
      organizationType: [OrganizationType.STARTUP, OrganizationType.SME],
      businessAge: 0,
  ...
  // Bank Loans - India
  {
    ...
    eligibility: {
      ...
      minIncome: 500000,
      creditScoreMin: 700,
      organizationType: [OrganizationType.SME, OrganizationType.STARTUP],
      businessAge: 12,
  ...
  // Private/Fintech Lenders - India
  {
    id: "fintech-lendingkart-1",
    name: "LendingKart Business Loan",
    lender: "LendingKart",
    lenderType: LenderType.FINTECH,
    category: LoanCategory.SME,
    country: "India",
    interestRate: "16-30%",
    loanAmount: {
  ...
  // Education Loans
  {
    ...
    eligibility: {
      ...
      minIncome: 200000,
      creditScoreMin: 650,
      organizationType: [OrganizationType.INDIVIDUAL, OrganizationType.INSTITUTION],
      businessAge: 0,
      sector: ["education"]
    },
  ...
  // Agriculture Loans
  {
    ...
    lender: "Government of India",
    lenderType: LenderType.GOVERNMENT,
    category: LoanCategory.AGRICULTURE,
    country: "India",
    interestRate: "4-7%",
    loanAmount: {
      min: 25000,
    ...
    eligibility: {
      ...
      minIncome: 50000,
      creditScoreMin: 0,
      organizationType: [OrganizationType.INDIVIDUAL, OrganizationType.FARMER, OrganizationType.COOPERATIVE],
      businessAge: 0,
...
// Export utility functions for working with loan data
export const getLoanData = (): Loan[] => LOAN_DATA;

export const getLoanById = (id: string): Loan | undefined => {
  return LOAN_DATA.find(loan => loan.id === id);
};

export const getLoansByCountry = (country: string): Loan[] => {
  return LOAN_DATA.filter(loan => 
    loan.country.toLowerCase() === country.toLowerCase()
  );
};

export const getLoansByCategory = (category: LoanCategory): Loan[] => {
  return LOAN_DATA.filter(loan => loan.category === category);
};

export const getLoansByLenderType = (lenderType: LenderType): Loan[] => {
  return LOAN_DATA.filter(loan => loan.lenderType === lenderType);
};

export const getUniqueCountries = (): string[] => {
  const countries = [...new Set(LOAN_DATA.map(loan => loan.country))];
  return countries.sort();
};

export const getUniqueLenders = (): string[] => {
  const lenders = [...new Set(LOAN_DATA.map(loan => loan.lender))];
  return lenders.sort();
};